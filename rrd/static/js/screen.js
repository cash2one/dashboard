$(function() {
    ...
    $('#searchinput2').on('click', function(e) {
        e.preventDefault();
        e.stopPropagation();
        // console.log($(e.target));
    });
    $('#searchinput2').on('keyup', debouncer(function(e) {
        var $el = $(e.target);
        var val = $el.val();
        // console.log('1', val);
        var screenEls = $el.parent().parent().nextAll();
    ...
    $('#searchinput3').on('click', function(e) {
        e.preventDefault();
        e.stopPropagation();
        // console.log($(e.target));
    });
    $('#searchinput3').on('keyup', debouncer(function(e) {
        var $el = $(e.target);
        var val = $el.val();
        // console.log('1', val);
        var screenEls = $el.parent().parent().nextAll();
    ...
    $('#searchinput4').on('click', function(e) {
        e.preventDefault();
        e.stopPropagation();
        // console.log($(e.target));
    });
    $('#searchinput4').on('keyup', debouncer(function(e) {
        var $el = $(e.target);
        var val = $el.val();
        // console.log('1', val);
        var screenEls = $el.parent().parent().nextAll();
